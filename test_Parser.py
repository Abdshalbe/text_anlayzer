...
sentence1 = [['harry', 'rode', 'silver', 'chariot'], ['shined', 'like', 'star', 'platinum'],['known', 'red', 'magician']]
sentence2 = []
sentence3 = [['under', 'tuft', 'jet', 'black', 'hair', 'boy', 'forehead', 'dumbledore', 'and', 'mcgonagall', 'could', 'see',
...
sentence4 = [['under', 'tuft', 'jet', 'black', 'hair', 'boy', 'forehead', 'dumbledore', 'and', 'mcgonagall', 'could', 'see',
         'curiously', 'shaped', 'cut', 'like', 'bolt', 'lightning'],
        ['is', 'that', 'where', 'whispered', 'professor', 'mcgonagall'],
        ['yes', 'said', 'dumbledore', 'dumbledore', 'll', 'have', 'that', 'scar', 'forever', 'couldn', 't', 'you', 'do',
         'something', 'about', 'scar', 'dumbledore', 'even', 'if', 'i', 'could', 'i', 'wouldn', 't']]
