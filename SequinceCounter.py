...
def generate_k_seqs(sentences:list[list[str]], N) ->  dict[str, dict[tuple[str], int]]:
    """
    ...
    for sentence in sentences:
        sentence = [word for word in sentence]  # Process sentence
        for k in range(1, N + 1):
    ...
    # Sort the sequences lexicographically by their tuple key (using lambda)
    for k in range(1, N + 1):
...
class SequinceCounter:
    ...
    def __init__(self, question_num: int, sentence_input_path: typing.Union[str, os.PathLike] = None,
                 remove_input_path: typing.Union[str, os.PathLike] = None, people_input_path: typing.Union[str, os.PathLike] = None,
    ...
    def __load_preprocessed_data(self, json_file_path: typing.Union[str, os])->Exception|None:
        """
        ...
        try:
            ...
            print(f"FileNotFoundError: The file {json_file_path} was not found.")
            raise
        except json.JSONDecodeError:
            print(f"JSONDecodeError: The file {json_file_path} is not a valid JSON file.")
            raise
        except PermissionError:
            print(f"PermissionError: Permission denied to read {json_file_path}.")
            raise
        except Exception as e:
            print(f"An error occurred while loading preprocessed data: {str(e)}")
            raise

    def __load_data(self, sentence_input_path: typing.Union[str, os], remove_input_path: typing.Union[str, os])->None:
        """
        ...
        """
        try:
            dataLoader = Preprocesser.Preprocessor(1, sentenceInputPath=sentence_input_path, removeInputPath=remove_input_path)
    ...
    def count_sequences(self) -> list[list[str | list[list[str | int]]]]:
        ...
        """
        return self.convert_to_json_style(generate_k_seqs(self.__sentences,self.__N))

    def convert_to_json_style(self, seq_counts: dict[str,list[tuple[tuple[str], int]]]) -> list[list[str | list[list[str, int]]]]:
        """
    ...
    def write_to_json(self, filePath: typing.Union[os,str])->bool:
        """
        try to write to a json file the results of the class SEQUENCE_COUNTER
            ...
            with open(filePath, 'w', encoding='utf-8') as f:
                ...
                data = {
                    f"Question {self.__questionNum}": {
                        f"{self.__N}-Seq Counts": self.convert_to_json_style(self.count_sequences())
                    }
                }
...
if __name__ == '__main__':
    SEQUENCE_COUNTER1 = SequinceCounter(2,
                                        sentence_input_path="text_analyzer/2_examples/Q2_examples/example_1/sentences_small_1.csv"
                                        ,
    ...
    #                                     sentence_input_path=r"C:\Users\abdsh\OneDrive\Desktop\huji cs\intro\finalProject\text_analyzer\2_examples\Q2_examples\example_2\sentences_small_1.csv",
    #                                     remove_input_path=r"C:\Users\abdsh\OneDrive\Desktop\huji cs\intro\finalProject\text_analyzer\1_data\data\REMOVEWORDS.csv",
    #                                     N=3)
    ...
    #                                     remove_input_path=r"C:\Users\abdsh\OneDrive\Desktop\huji cs\intro\finalProject\text_analyzer\1_data\data\REMOVEWORDS.csv",
    #                                     N=3)
    # SEQUENCE_COUNTER4 = SequinceCounter(2, json_input_path="text_analyzer/Q1_result1.json",
    #                                     N=3)
    # SEQUENCE_COUNTER5 = SequinceCounter(2, json_input_path="text_analyzer/Q1_result2.json",
    #                                     N=4)
    # SEQUENCE_COUNTER6 = SequinceCounter(2, json_input_path="text_analyzer/Q1_result3.json",
    #                                     N=5)
